...
// button function
 function openLoginPage() {
            window.location.href = 'flip-login.html'; // Replace with the path to your flip-login.html file
        }
		
function openGraphPage() {
            window.location.href = 'Graph.html'; // Replace with the path to your flip-login.html file
        }
